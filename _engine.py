...
from _coco_utils import get_coco_api_from_dataset
from _coco_eval import CocoEvaluator
import _utils
...
def train_one_epoch(model, optimizer, data_loader, device, epoch, print_freq):
    ...
    if epoch == 0:
        ...
        lr_scheduler = _utils.warmup_lr_scheduler(optimizer, warmup_iters, warmup_factor)
